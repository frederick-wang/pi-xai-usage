...
When your output names a domain concept (in an issue title, a refactor proposal, a hypothesis, a test name), use the term as defined in `CONTEXT.md` (Plan provider, Included allowance, On-demand usage, Prepaid balance, Quota window, Snapshot, Stale, Reset time, Plan tier, Account fingerprint). Don't drift to synonyms the glossary explicitly avoids.
...
> _Contradicts ADR-0002 (OAuth subscription not API key) — but worth reopening because…_
